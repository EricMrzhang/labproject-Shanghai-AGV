...
public:
    TPathTrack()
    {
        ...
        charge_station_sub = nh->subscribe<car_ctr::charge_station>("/charge_station", 10, &TPathTrack::ChargeStationCallback, this);   
...
void TPathTrack::ChargeStationCallback(const car_ctr::charge_station::ConstPtr &msg)
{
    charge_station=*msg;
}
