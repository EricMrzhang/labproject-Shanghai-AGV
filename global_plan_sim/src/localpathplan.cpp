...
public:
    TLocalPathPlan()
    {
        ...
        carstate_sub = nh->subscribe<car_ctr::car_state>("/car_ctr/car_state", 10, &TLocalPathPlan::CarStateCallback, this);
...
void TLocalPathPlan::CarStateCallback(const car_ctr::car_state::ConstPtr &msg) //  接收车体状态信息
{
    cur_carstate = *msg;
}
...
{
    float acc_per_len=6.0/10, dec_per_len=-6.0/10;   //  速度/距离系数
