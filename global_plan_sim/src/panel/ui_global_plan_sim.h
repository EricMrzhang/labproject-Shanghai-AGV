...
public:
    ...
    QPushButton *btn_charge_ready;
    QPushButton *btn_charge;
    QPushButton *btn_charge_close;
    QHBoxLayout *horizontalLayout_3;
    QPushButton *btn_cleartrack;
    QPushButton *btn_stop;
    QPushButton *btn_syscheck;
    QPushButton *btn_home;
    QPushButton *btn_obstacle;
    QPushButton *btn_sample;
...
"font: 16pt \"Ubuntu\";"));
        ...
        btn_charge_ready = new QPushButton(Panel_Global_Plan_Sim);
        btn_charge_ready->setObjectName(QString::fromUtf8("btn_charge_ready"));
        btn_charge_ready->setStyleSheet(QString::fromUtf8("background-color: rgb(211, 215, 207);\n"
"font: 16pt \"Ubuntu\";"));

        horizontalLayout->addWidget(btn_charge_ready);

        btn_charge = new QPushButton(Panel_Global_Plan_Sim);
        btn_charge->setObjectName(QString::fromUtf8("btn_charge"));
        btn_charge->setStyleSheet(QString::fromUtf8("background-color: rgb(211, 215, 207);\n"
"font: 16pt \"Ubuntu\";"));

        horizontalLayout->addWidget(btn_charge);

        btn_charge_close = new QPushButton(Panel_Global_Plan_Sim);
        btn_charge_close->setObjectName(QString::fromUtf8("btn_charge_close"));
        btn_charge_close->setStyleSheet(QString::fromUtf8("background-color: rgb(211, 215, 207);\n"
"font: 16pt \"Ubuntu\";"));

        horizontalLayout->addWidget(btn_charge_close);
...
"font: 16pt \"Ubuntu\";"));
        ...
        btn_home = new QPushButton(Panel_Global_Plan_Sim);
        btn_home->setObjectName(QString::fromUtf8("btn_home"));
        btn_home->setStyleSheet(QString::fromUtf8("background-color: rgb(211, 215, 207);\n"
"font: 16pt \"Ubuntu\";"));

        horizontalLayout_3->addWidget(btn_home);

        btn_obstacle = new QPushButton(Panel_Global_Plan_Sim);
        btn_obstacle->setObjectName(QString::fromUtf8("btn_obstacle"));
        btn_obstacle->setStyleSheet(QString::fromUtf8("background-color: rgb(211, 215, 207);\n"
"font: 16pt \"Ubuntu\";"));

        horizontalLayout_3->addWidget(btn_obstacle);

        btn_sample = new QPushButton(Panel_Global_Plan_Sim);
        btn_sample->setObjectName(QString::fromUtf8("btn_sample"));
        btn_sample->setStyleSheet(QString::fromUtf8("background-color: rgb(211, 215, 207);\n"
"font: 16pt \"Ubuntu\";"));

        horizontalLayout_3->addWidget(btn_sample);
    ...
    void retranslateUi(QWidget *Panel_Global_Plan_Sim)
    {
        ...
        btn_charge->setText(QApplication::translate("Panel_Global_Plan_Sim", "\345\205\205\347\224\265", nullptr));
        btn_charge_close->setText(QApplication::translate("Panel_Global_Plan_Sim", "\345\205\205\347\224\265\345\205\263\351\227\255", nullptr));
        ...
        btn_home->setText(QApplication::translate("Panel_Global_Plan_Sim", "HOME", nullptr));
        btn_obstacle->setText(QApplication::translate("Panel_Global_Plan_Sim", "\351\201\277\351\232\234", nullptr));
        btn_sample->setText(QApplication::translate("Panel_Global_Plan_Sim", "\351\207\207\351\233\206", nullptr));
    } // retranslateUi
